...
# 🔥 News
- 2026/9-[从 Agent 开发到 Agent 算法的业务迭代方法论](https://mp.weixin.qq.com/s/0YFG-J2ZWwRO4lTP7f1JDA):基于个人实践交流经验，沉淀Agent 业务迭代方法Benchmark→策略→上线分享agent迭代方案从make sense到work再到solid的实践指南
